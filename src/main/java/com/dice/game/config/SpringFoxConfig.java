...
public class SpringFoxConfig  extends WebMvcConfigurerAdapter {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Dice Game API")
                .description("Dice Game API reference for developers")
                .termsOfServiceUrl("http://google.com")
                .contact(new Contact("Kamrul Islam Tushar", "https://github.com/kamrulislamtushar", "ki.tushar21@gmail.com")).build();
    }
